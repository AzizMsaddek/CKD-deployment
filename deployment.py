...
def main():
    ...
    bp = st.number_input('Blood Pressure:', min_value=0.0, max_value=100.0, value=1.0)
    sg = st.number_input('Specific Gravity:', min_value=0.0, max_value=100.0, value=1.0)
    ...
    bgr = st.number_input('Blood Glucose Random:', min_value=0.0, max_value=100.0, value=1.0)
    bu = st.number_input('Blood Urea:', min_value=0.0, max_value=100.0, value=1.0)
    sc = st.number_input('Serum Creatinine:', min_value=0.0, max_value=100.0, value=1.0)
    sod = st.number_input('Sodium:', min_value=0.0, max_value=100.0, value=1.0)
    pot = st.number_input('Potassium:', min_value=0.0, max_value=100.0, value=1.0)
    hemo = st.number_input('Hemoglobin:', min_value=0.0, max_value=100.0, value=1.0)
    pcv = st.number_input('Packed  Cell Volume:', min_value=0.0, max_value=100.0, value=1.0)
    wbcc = st.number_input('White Blood Cell Count:', min_value=0.0, max_value=100.0, value=1.0)
    rbcc = st.number_input('Red Blood Cell Count:', min_value=0.0, max_value=100.0, value=1.0)
